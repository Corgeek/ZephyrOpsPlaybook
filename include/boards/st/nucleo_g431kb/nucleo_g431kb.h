...
#define GPIOA_PIN12                 GPIO_PORT_PIN(gpioa, 12)        // D2, ARD_D2, PA12, -
#define GPIOB_PIN00                 GPIO_PORT_PIN(gpiob,  0)        // D3, ARD_D3, PB0, -
...
#define GPIOB_PIN06                 GPIO_PORT_PIN(gpiob,  6)        // D6, ARD_D6, PB6, -
#define GPIOF_PIN00                 GPIO_PORT_PIN(gpiof,  0)        // D7, ARD_D7, PF0, -
#define GPIOF_PIN01                 GPIO_PORT_PIN(gpiof,  1)        // D8, ARD_D8, PF1, -
#define GPIOA_PIN08                 GPIO_PORT_PIN(gpioa,  8)        // D9, ARD_D9, PA8, I2C3_SCL
#define GPIOA_PIN11                 GPIO_PORT_PIN(gpioa, 11)        // D10, ARD_D10, PA11, TIM1_CH4
#define GPIOB_PIN05                 GPIO_PORT_PIN(gpiob,  5)        // D11, ARD_D11, PB5, I2C3_SDA
